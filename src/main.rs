...
use structures::{Background, Light, Material, Scene, Sphere, Traceable};
...
fn main() {
    ...
    objects.push(Box::new(Sphere::new(
        Vec3::new(-1f32, 3.5f32, -7f32),
        2f32,
        red,
    )));
    objects.push(Box::new(Sphere::new(
        Vec3::new(3f32, -3f32, -6f32),
        2f32,
        mirror,
    )));
    objects.push(Box::new(Sphere::new(
        Vec3::new(-3f32, 3f32, -5f32),
        2f32,
        glass,
    )));
    ...
    raytracer::render(main_scene, Background::new(background));
}
